 ...
 * @since 4.0.0
 *
 * @param string $response_code Get paypal response code
 * @return mixed|string
 */
function vt_response_code_description($response_code) {

    $responseCodes = apply_filters( 'response_code_description', [
