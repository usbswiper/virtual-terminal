 ...
 * @extends \WC_Email
 */
class UsbSwiperPaypalConnectedEmail extends WC_Email {
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'subject'            => array(
				...
				'type'        => 'text',
				'placeholder' => __( 'USBSwiper VT - PayPal Account Connected Successfully', 'usb-swiper' ),
				'default'     => '',
			),
			'heading'            => array(
...
return new UsbSwiperPaypalConnectedEmail();