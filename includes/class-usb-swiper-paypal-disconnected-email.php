...
/**
 * Email class for Paypal Disconnected Notification
 *
 * @since 1.1.9
 * @extends \WC_Email
 */
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'subject'            => array(
				...
				'type'        => 'text',
				'placeholder' => __( 'USBSwiper VT - PayPal Account Disconnected', 'usb-swiper' ),
				'default'     => '',
			),
			'heading'            => array(
...
return new UsbSwiperPaypalDisconnectedEmail();