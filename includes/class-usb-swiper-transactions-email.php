...
/**
 * Email class for Transaction Email Notification to customer
 *
 * @extends \WC_Email
 */
...
class UsbSwiperTransactionEmail extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->id = 'transaction_email';

        // this is the title in WooCommerce Email settings
        $this->title = __('Transaction Email', 'usb-swiper');

        // this is the description in WooCommerce email settings
        $this->description = __('Email Sent when a user Create a Transaction.', 'usb-swiper');

        // these are the default heading and subject lines that can be overridden using the settings
        $this->heading = __( 'Transaction {#transaction_id#}', 'usb-swiper' );
        $this->subject = __( 'Your Transaction {#transaction_id#} has been Received ', 'usb-swiper');

        // these define the locations of the templates that this email should use
        $this->template_base  = USBSWIPER_PATH . 'templates/';
        $this->template_html  = 'emails/transaction-email.php';
        $this->template_plain = 'emails/plain/transaction-email.php';
    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
            ...
            'subject'            => array(
                ...
                'type'        => 'text',
                'placeholder' => __( 'Your Transaction {#transaction_id#} has been Received ', 'usb-swiper'),
                'default'     => '',
            ),
            'heading'            => array(
...
return new UsbSwiperTransactionEmail();