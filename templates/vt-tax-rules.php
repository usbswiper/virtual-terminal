        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="tax-actions">
                    ...
                    <a title="<?php _e('Delete Tax Rule', 'usb-swiper'); ?>" data-nonce="<?php echo wp_create_nonce('vt-remove-tax'); ?>" href="<?php echo esc_url(add_query_arg(array('action' => 'delete', 'tax_id' => $tax_item_key), wc_get_endpoint_url('vt-tax-rules', '', wc_get_page_permalink('myaccount')))); ?>" class="vt_delete_taxrule" data-tax-index="<?php echo $tax_item_key; ?>">
