	...
	<table class="woocommerce-transactions-table woocommerce-MyAccount-transactions shop_table shop_table_responsive my_account_transactions account-transactions-table">
		...
		<tbody>
			...
			foreach ( $transactions as $transaction ) {
                ...
                $grand_total = ( (strtolower($transaction_type) === 'transaction-refund') || (strtolower($transaction_type) === 'invoice-refund') || (strtolower($transaction_type) === 'zettle-refund') ) ? get_post_meta( $id, '_transaction_amount', true ) : get_post_meta( $id, 'GrandTotal', true );
